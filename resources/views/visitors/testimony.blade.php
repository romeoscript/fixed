        ...
        <nav class="navbar navbar-expand-lg sticky-top change" id="navbar" >
          ...
          <div class="col-md-5">
            <div class="card card-body">
                ...
                <p class="card-text"> Through in-depth discussion Jeremy encourages us to
                    ...
                    fixotrade  script investment is very client centred and professional and we would happily recommend their services to others.</p>
                <!-- <br> -->
          ...
          <div class="col-md-5">
            <div class="card card-body">
                ...
                <i class="fas fa-quote-left" style="text-align: left;color: purple;"></i>
                <p class="card-text">Since investing withfixotrade  script,
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="card card-body">
                  ...
                  <i class="fas fa-quote-left" style="text-align: left;color: purple;"></i>
                  <p class="card-text">Wow this is wonderfully, it works like magic. More grace to your elbowfixotrade  script and Investment Platform.
            ...
            <div class="col-md-5">
              <div class="card card-body">
                  ...
                  <p class="card-text">I have been into many trading close to 4years now. Many strategy I have tried but all failed.
                       I got frustrated and was almost calling it quit. Little did I know that afixotrade  script existed and had auto trading....Thanks i stumbled on there facebook advert</p>
                  <!-- <br> -->
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="card card-body">
                  ...
                  <i class="fas fa-quote-left" style="text-align: left;color: purple;"></i>
                  <p class="card-text">FLOROUSHX  script INVEST is the real deal. I could not believe my eyes when they paid me my returns and through it,
                       I paid my children's school fees and it also assisted me to take care of my domestic duties. GOD bless youfixotrade  script </p>
                  <!-- <br> -->
