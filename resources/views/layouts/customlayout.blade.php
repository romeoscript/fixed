...
<!-- Mirrored from reefresources-fm.com/{{route('register')}} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Dec 2021 10:31:50 GMT -->
...
<head>
    ...
    <script src="{{asset('kit.fontawesome.com/a076d05399.js')}}"></script>
...
<!-- container-scroller -->
<!-- plugins:js --><!--Start of Tawk.to Script-->
...
<script src="{{asset('translate.google.com/translate_a/elementa0d8.js?cb=googleTranslateElementInit" type="text/javascript')}}"></script>
