																...
																<table width='100%' border='0' cellspacing='0' cellpadding='0'>
																	<tr>
																		...
																		<td style='padding: 30px 0px;'>
																			<table width='100%' border='0' cellspacing='0' cellpadding='0'>
																				<tr>
																					<td class='h1 center pb25' style='color:#ffffff; font-family:Noto Sans, Arial,sans-serif; font-size:40px; line-height:46px; text-align:center; padding-bottom:25px;'>FLOROUSHX</td>
																				</tr>
																				<tr>
													...
													<tr>
														<td class='p30-15' style='padding: 50px 30px;'>
															<table width='100%' border='0' cellspacing='0' cellpadding='0'>
																...
																<tr>
																	<td class='text pb20' style='color:#777777; font-family:Noto Sans, Arial,sans-serif; font-size:14px; line-height:26px; text-align:left; padding-bottom:20px;'><br> Dear valued client, <br> <br> {!! $emaildata['email_body'] !!}</td>
																</tr>
										...
										<tr>
											<td class='p30-15' style='padding: 50px 30px;' bgcolor='#ffffff'>
												<table width='100%' border='0' cellspacing='0' cellpadding='0'>
													...
													<tr>
														<td class='text-footer1 pb10' style='color:#999999; font-family:Noto Sans, Arial,sans-serif; font-size:16px; line-height:20px; text-align:center; padding-bottom:10px;'>FLOROUSHX- Recommended by Google</td>
													</tr>
													<tr>
