            ...
            <div class="text-box service-box bg-secondary h-full">
                <h4 class="fw-6 mtm-5">HOW TO INVEST</h4>
                                        <ul>
                                            ...
                                            <li><p><i class="fa fa-check-square"></i> -Send the duly completed form and evidence of payment to support@fixotradecapital.com</p></li><br>
                    ...
                    <a href="user/{{route('register')}}" class="btn">Start Banking On Land</a>
    </div>
